...
export class XmModalStack {
  ...
  open(moduleCFR: ComponentFactoryResolver, contentInjector: Injector, content: any, options): XmModalRef {
    ...
    let backdropCmptRef: ComponentRef<XmModalBackdropComponent> =
      options.backdrop !== false ? this._attachBackdrop(moduleCFR, containerEl) : null;
    let windowCmptRef: ComponentRef<XmModalWindowComponent> = this._attachWindowComponent(moduleCFR, containerEl, contentRef);
    let xmModalRef: XmModalRef = new XmModalRef(windowCmptRef, contentRef, backdropCmptRef, options.beforeDismiss);
  ...
  private _attachBackdrop(moduleCFR: ComponentFactoryResolver, containerEl: any): ComponentRef<XmModalBackdropComponent> {
    let backdropFactory = moduleCFR.resolveComponentFactory(XmModalBackdropComponent);
  ...
  private _attachWindowComponent(moduleCFR: ComponentFactoryResolver, containerEl: any, contentRef: any):
    ...
    let windowFactory = moduleCFR.resolveComponentFactory(XmModalWindowComponent);
